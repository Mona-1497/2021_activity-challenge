...
tiilelb=Label(root,text='Your Group - Shared Activities',font=20,padx=40,pady=20,bg='#064134',fg='white')
tiilelb.grid(row=0,column=30)
...
lb2=Label(root,text='your groups that have new activities that you can paticipate in right now!',bg='#064134')
